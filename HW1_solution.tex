...
We choose the arc length parameter $s^{\lambda}$ for curve $\gamma^{\lambda}$, 
and the arc length parameter for $\gamma$ is denoted by $s$.
$$s^{\lambda} =\int_{t_0}^t \norm{\diff{\gamma^{\lambda}}{v}}dv \Rightarrow \diff{s^{\lambda}}{t} = \norm{\diff{\gamma^{\lambda}}{t}} = \abs{1-\lambda\kappa_s}\norm{\gamma'(t)}$$
\begin{align*}
\widetilde{T} & = \diff{\gamma^{\lambda}}{s^{\lambda}} = \frac{\diff{\gamma^{\lambda}}{t}}{\diff{s^{\lambda}}{t}} = \frac{(1-\lambda \kappa_s)\gamma'(t)}{\abs{1-\lambda \kappa_s}\norm{\gamma'(t)}}\\
 &  = \sgn\{1-\lambda\kappa_s\}\frac{\gamma'(t)}{\norm{\gamma'(t)}} = \sgn\{1-\lambda\kappa_s\} T \\
 & \Rightarrow \tilde{\bm{n}}_s=\sgn\{1-\lambda \kappa_s\}\bm{n}_s
\end{align*}
Since $\kappa_s(t)$ is continuous and $\lambda \kappa_s(t)\neq 1$, $1-\lambda \kappa_s(t)$ has constant sign.
Therefore $\gamma^{\lambda} \neq 0$ and $\gamma^{\lambda}$ is regular.
$$
\diff{\widetilde{T}}{s^{\lambda}}=\frac{\diff{\widetilde{T}}{t}}{\diff{s^{\lambda}}{t}}
 = \frac{\sgn\{1-\lambda \kappa_s\} \diff{T}{t}}{\abs{1-\lambda \kappa_s}\norm{\gamma'(t)}}
 = \frac{\sgn\{1-\lambda \kappa_s\}}{\abs{1-\lambda \kappa_s}} \diff{T}{s}
$$
Let $\kappa_s$ be the signed curvature of $\gamma$ and $\tilde{\kappa}_s$ be the signed curvature of $\gamma^{\lambda}$.
Then
$$
\tilde{\kappa}_s = \diff{\widetilde{T}}{s}\cdot \tilde{\bm{n}}_s =\frac{\sgn^2\{1-\lambda\kappa_s\}}{\abs{1-\lambda\kappa_s}}\diff{T}{s} \cdot \bm{n}_s
